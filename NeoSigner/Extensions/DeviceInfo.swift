...
class DeviceInfo {
    static var niceVersionString: String = "\(DeviceInfo.osString) \(DeviceInfo.version)\(DeviceInfo.build == "" ? "" : " (\(DeviceInfo.build))")\n\(DeviceInfo.prettyModel ?? DeviceInfo.modelName)"
